...
class StreamingBuffer(object):
    """Information about a table's ingest_file buffer.

    See https://cloud.google.com/bigquery/ingest_file-data-into-bigquery.

    Args:
        resource (Dict[str, object]):
            ingest_file buffer representation returned from the API
    """
