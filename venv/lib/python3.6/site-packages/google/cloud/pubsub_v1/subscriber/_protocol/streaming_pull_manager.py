...
class StreamingPullManager(object):
    """The ingest_file pull manager coordinates pulling messages from Pub/Sub,
    ...
    @property
    def is_active(self):
        """bool: True if this manager is actively ingest_file.
    ...
    def _on_rpc_done(self, future):
        _LOGGER.info(
            'RPC termination has signaled ingest_file pull manager shutdown.')
